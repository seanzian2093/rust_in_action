#[allow(unused)]
use crate::graphics::math::{Vec2d, add, mul_scalar};
use piston_window::*;
use rand::prelude::*;
...
unsafe impl GlobalAlloc for ReportingAllocator {
    unsafe fn alloc(&self, layout: Layout) -> *mut u8 {
        ...
        // This line cause segmentation fault, not sure why or how to fix
...
impl Particle {
    fn new(world: &World) -> Particle {
        ...
        Particle {
            ...
            width: 4.0,
            position: [x, y].into(),
            velocity: [x_velocity.into(), y_velocity],
...
pub fn main() {
    ...
    let mut window: PistonWindow = WindowSettings::new("ch6_particles", [width, height])
        .exit_on_esc(true)
        .build()
